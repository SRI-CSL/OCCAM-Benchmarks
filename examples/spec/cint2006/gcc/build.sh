...
function usage() {
    echo "Usage: $0 [--disable-inlining] [--ipdse] [--use-crabopt] [--use-pointer-analysis] [--inter-spec VAL1] [--intra-spec VAL1] [--help]"
...
echo "============================================================"
slash ${SLASH_OPTS} --work-dir=slash  gcc.manifest
